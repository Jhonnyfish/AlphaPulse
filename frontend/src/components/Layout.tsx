...
import { BarChart3, Star, TrendingUp, Newspaper, LogOut, Activity, CandlestickChart, LayoutDashboard, Menu, X, GitCompareArrows, Settings, Briefcase, BookOpen, Target, Filter, Crown, Flame, Zap, Radio, Grid3X3, Droplets } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/journal', label: '交易日志', icon: BookOpen },
  { to: '/candidates', label: '候选股', icon: Target },
  { to: '/screener', label: '选股器', icon: Filter },
  { to: '/analyze', label: '个股分析', icon: Activity },
  { to: '/flow', label: '资金流向', icon: Droplets },
